...
/**
 * {@link Annotation} for {@link Class}es and {@link Method}s that need to be called at the {@link Phase#PRE_DESTROY}
 * phase of a bean's life cycle.
 * <p>
 * {@link Method}s annotated with @{@link PreDestroy} support the following parameters:<br>
 * <ul>
 * <li>Of the type {@link Phase}</li>
 * <li>Any type annotated with {@link Resolve}</li>
 * </ul>
 * <p>
 * {@link Method}s annotated with @{@link PreDestroy} may not:<br>
 * <ul>
 * <li>be static</li>
 * </ul>
 */
...
public @interface PreDestroy {
	 ...
	 * {@link Method}'s {@link Class} annotated with @{@link PreDestroy}.
	 *
