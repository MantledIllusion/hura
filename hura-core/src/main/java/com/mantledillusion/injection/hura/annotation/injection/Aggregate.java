...
public @interface Aggregate {
     ...
     * <p>
     * If set to true (and multiple singletons match the predicates), a single random singleton of the aggregated ones is set to the field instead of causing an {@link com.mantledillusion.injection.hura.exception.AggregationException}.
     *
