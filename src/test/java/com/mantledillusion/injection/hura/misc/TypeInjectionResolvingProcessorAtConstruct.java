...
public class TypeInjectionResolvingProcessorAtConstruct implements Processor<InjectableWithInjectedPropertyField> {

	@Override
	public void process(InjectableWithInjectedPropertyField bean, TemporalInjectorCallback callback) throws Exception {
		bean.valueAtConstruct = bean.injectableProperty;
	}
}
