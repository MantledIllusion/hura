	...
	public void validate(Process annotationInstance, Method m) throws Exception {
		if (Modifier.isStatic(m.getModifiers())) {
			throw new ValidatorException("The " + ValidatorUtils.getDescription(m) + " is annotated with @"
					+ Process.class.getSimpleName() + " but is declared static, which is not allowed.");
			...
			throw new ValidatorException(
					"The " + ValidatorUtils.getDescription(m) + " is annotated with @" + Process.class.getSimpleName()
