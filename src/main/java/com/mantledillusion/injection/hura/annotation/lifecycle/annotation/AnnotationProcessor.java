...
/**
 * Interface for validators that process occurrences of a specifiable
 ...
 * when an {@link Annotation} (that itself is annotated with @{@link PreConstruct}
 * and specifies the {@link AnnotationProcessor} implementation) is found on an
 * {@link AnnotatedElement}.
 *
 * @param <A>
 *            The {@link Annotation} type this {@link AnnotationProcessor}
 *            inspects.
 * @param <E>
 *            The {@link AnnotatedElement} type the {@link Annotation} this
 *            {@link AnnotationProcessor} can be found on. Suitable types depend
 *            on the {@link Target} the {@link Annotation} this
 *            {@link AnnotationProcessor} validates might be annotated on.
 */
public interface AnnotationProcessor<A extends Annotation, E extends AnnotatedElement> {
	 ...
	 *            The instance of the {@link Annotation} to process that was found
	 *            on the {@link AnnotatedElement}; might <b>not</b> be null.
	 * @param annotatedElement
	 *            The {@link AnnotatedElement} the {@link Annotation} to process
