...
class InjectionAllocations {
	...
	private static void define(Blueprint.Allocation allocation, InjectionAllocations injectionAllocations) {
		if (allocation != null) {
			if (allocation instanceof SingletonAllocation) {
				SingletonAllocation singleton = (SingletonAllocation) allocation;
			...
			} else if (allocation instanceof PropertyAllocation) {
				PropertyAllocation property = (PropertyAllocation) allocation;
