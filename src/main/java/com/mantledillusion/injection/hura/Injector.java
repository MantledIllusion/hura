 ...
 * instantiated itself and/or referenced in case it is a {@link SingletonAllocation}.
 * <p>
 ...
 * {@link SingletonAllocation} beans further down the injection tree, but not up. As a
...
public class Injector implements InjectionProvider, ResolvingProvider {
     ...
     * of incoherent {@link SingletonAllocation} pools, since the currently running injection
     ...
     * special functionality that only the root of the injection tree has.
     *
     * @param allocations {@link Blueprint.Allocation}s to be used during injection, for
     *                    example {@link SingletonAllocation}s, {@link Blueprint.MappingAllocation}s
     ...
     *                   defining bindings such as {@link SingletonAllocation}s, {@link Blueprint.MappingAllocation}s
